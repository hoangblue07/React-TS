          ...
          <form>
            <div className='row'>
              ...
              <div className='col-6'>
                <div className='form-group'>
                  <p>Name</p>
                  <input className='form-control' name="name" value={userProfile?.name} />
                </div>
                <div className='form-group'>
                  <p>Password</p>
                  <input className='form-control' name="password" type="password" value={userProfile?.password ? userProfile?.password : ''} onChange={frmUserProfile.handleChange} />
                </div>
